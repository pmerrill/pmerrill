...
![MySQL](https://img.shields.io/badge/-SQL-000?style=flat&logo=MySQL&logoColor=white)
...
**Production:**
* **[College Hockey Dynasty](https://collegehockeydynasty.com)** - A from-scratch iOS GM sim for college hockey, built in Swift - a robust game engine with fatigue and line chemistry, NIL-era recruiting and dual-budget finances, and tournament seeding on the NPI ranking formula.
...
**Testing:**
* [Arrange-Act-Assert Pattern for Good Tests](https://automationpanda.com/2020/07/07/arrange-act-assert-a-pattern-for-writing-good-tests/) - Mindset for writing readable, maintainable, and useful tests
